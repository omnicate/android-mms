...
public class TimeImpl implements Time {
   ...
   *              if the timeValue input parameter does not comply with the defined syntax
   * @exception java.lang.NullPointerException
   *              if the timekValue string is <code>null</code>
   */
   ...
   * @exception java.lang.IllegalArgumentException
   *              if the clockValue input parameter does not comply with the defined syntax
   * @exception java.lang.NullPointerException
   *              if the clockValue string is <code>null</code>
   */
   ...
   *          The Value to parse
   * @param ignoreLast
   *          The size of Text to ignore
   * @param parseDecimal
   *          Whether Decimal is expected
   * @return The float value without Text, rounded to 3 digits after '.'
   * @throws IllegalArgumentException
   *           if Decimal was not expected but encountered
   */
